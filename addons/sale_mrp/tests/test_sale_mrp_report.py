...
classTestSaleMrpInvoices(common.SavepointCase):
    ...
    deftest_deliver_and_invoice_tracked_components(self):
        """
        Supposethelotsareprintedontheinvoices.
        Theusersellsakitthathasonetrackedcomponent.
        Thelotofthedeliveredcomponentshouldbeontheinvoice.
        """
        ...
        self.assertRegex(text,r'ProductByLot\n1.00\nUnits\nLOT0001',"Thereshouldbealinethatspecifies1xLOT0001")
