...
constInvitePartnerDialog=require('mail/static/src/widgets/discuss_invite_partner_dialog/discuss_invite_partner_dialog.js');
...
constDiscussWidget=AbstractAction.extend({
    ...
    asyncwillStart(){
        ...
        awaitthis.env.messagingCreatedPromise;
        constinitActiveId=this.options.active_id||
    ...
    on_attach_callback(){
        this._super(...arguments);
        if(this.component){
            //preventtwicecalltoon_attach_callback(FIXME)
            return;
        }
        constDiscussComponent=components.Discuss;
        this.component=newDiscussComponent();
    ...
    _showRainbowMan(){
        this.trigger_up('show_effect',{
            message:this.env._t("Congratulations,yourinboxisempty!"),
            type:'rainbow_man',
        });
    },
    /**
    ...
    _onClickMarkAllAsRead(){
        constdomain=this.discuss.stringifiedDomain?JSON.parse(this.discuss.stringifiedDomain):undefined;
