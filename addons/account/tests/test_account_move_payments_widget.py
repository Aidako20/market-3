...
classTestAccountMovePaymentsWidget(AccountTestInvoicingCommon):
    ...
    defsetUpClass(cls,chart_template_ref=None):
        ...
        cls.currency_data_2=cls.setup_multi_currency_data(default_values={
            ...
            'currency_subunit_label':'LittleStars',
    ...
    def_test_all_outstanding_payments(self,invoice,expected_amounts):
        '''Checktheoutstandingpaymentswidgetbefore/afterthereconciliation.
        :paraminvoice:            Anaccount.moverecord.
        :paramexpected_amounts:   Amap<move_id>-><amount>
        '''

        #Checksuggestedoutstandingpayments.
        ...
        current_amounts={vals['move_id']:vals['amount']forvalsinto_reconcile_payments_widget_vals['content']}
        ...
        to_reconcile=self.env['account.move'].browse(list(current_amounts.keys()))\
            .line_ids\
            .filtered(lambdaline:line.account_id==pay_term_lines.account_id)
        (pay_term_lines+to_reconcile).reconcile()

        #Checkpaymentsafterreconciliation.
        ...
        current_amounts={vals['move_id']:vals['amount']forvalsinreconciled_payments_widget_vals['content']}
        self.assertDictEqual(current_amounts,expected_amounts)
    ...
    deftest_outstanding_payments_single_currency(self):
        '''Testtheoutstandingpaymentswidgetoninvoiceshavingthesamecurrency
        asthecompanyone.
        '''

        #Customerinvoiceof2500.0incurr_1.
    ...
    deftest_outstanding_payments_foreign_currency(self):
        '''Testtheoutstandingpaymentswidgetoninvoiceshavingaforeigncurrency.'''
