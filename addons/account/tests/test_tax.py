...
classTestTaxCommon(AccountTestInvoicingCommon):

    @classmethod
    defsetUpClass(cls,chart_template_ref=None):
        super().setUpClass(chart_template_ref=chart_template_ref)

        #Setupanothercompanyhavingaroundingof1.0.
...
classTestTax(TestTaxCommon):
    ...
    deftest_tax_group_percent(self):
    ...
    deftest_tax_percent_division(self):
    ...
    deftest_tax_sequence_normalized_set(self):
    ...
    deftest_fixed_tax_include_base_amount(self):
        self.fixed_tax.include_base_amount=True
        res=self.group_tax.compute_all(200.0)
        self._check_compute_all_results(
            231,    #'total_included'
    ...
    deftest_percent_tax_include_base_amount(self):
        self.percent_tax.price_include=True
    ...
    deftest_tax_decimals(self):
        """Testtheroundingoftaxesupto6decimals(maximumdecimalsplacesallowedforcurrencies)"""
    ...
    deftest_advanced_taxes_computation_0(self):
        '''Testmoreadvancedtaxescomputation(seeissue34471).'''
    ...
    deftest_intracomm_taxes_computation_0(self):
        '''Testusageofintracommtaxeshavinge.g.+100%,-100%asrepartitionlines.'''
    ...
    deftest_rounding_issues_0(self):
        '''Testtaxeshavingacomplexsetupofrepartitionlines.'''
    ...
    deftest_rounding_issues_1(self):
        '''Testtaxeshavingacomplexsetupofrepartitionlines.'''
        tax=self.env['account.tax'].create({
    ...
    deftest_rounding_tax_excluded_round_per_line_01(self):
        '''Testtheroundingofa19%priceexcludedtaxinaninvoicehaving22689and9176aslines.
        Thedecimalprecisionissettozero.
        Thecomputationmustbesimilartoround(22689*0.19)+round(9176*0.19).
        '''
    ...
    deftest_rounding_tax_excluded_round_globally(self):
        '''Testtheroundingofa19%priceexcludedtaxinaninvoicehaving22689and9176aslines.
        Thedecimalprecisionissettozero.
        Thecomputationmustbesimilartoround((22689+9176)*0.19).
        '''
    ...
    deftest_rounding_tax_included_round_per_line_01(self):
        '''Testtheroundingofa19%priceincludedtaxinaninvoicehaving27000and10920aslines.
        Thedecimalprecisionissettozero.
        Thecomputationmustbesimilartoround(27000/1.19)+round(10920/1.19).
        '''
    ...
    deftest_rounding_tax_included_round_per_line_02(self):
        '''Testtheroundingofa12%priceincludedtaxinaninvoicehaving52.50asline.
        Thedecimalprecisionissetto2.
        '''
    ...
    deftest_rounding_tax_included_round_per_line_03(self):
        '''Testtheroundingofa8%and0%priceincludedtaxinaninvoicehaving8*15.55asline.
        Thedecimalprecisionissetto2.
        '''
    ...
    deftest_rounding_tax_included_round_per_line_04(self):
        '''Testtheroundingofa5%priceincludedtax.
        Thedecimalprecisionissetto0.05.
        '''
    ...
    deftest_rounding_tax_included_round_globally_01(self):
        '''Testtheroundingofa19%priceincludedtaxinaninvoicehaving27000and10920aslines.
        Thedecimalprecisionissettozero.
        Thecomputationmustbesimilartoround((27000+10920)/1.19).
        '''
        self.tax_19_percent.price_include=True
        self.tax_19_percent.company_id.tax_calculation_rounding_method='round_globally'
    ...
    deftest_rounding_tax_included_round_globally_02(self):
        '''Testtheroundingofa21%priceincludedtaxinaninvoicehaving11.90and2.80aslines.
        Thedecimalprecisionissetto2.
        '''
    ...
    deftest_rounding_tax_included_round_globally_03(self):
        '''Testtheroundingofa5%priceincludedtax.
        Thedecimalprecisionissetto0.05.
        '''
        self.tax_5_percent.price_include=True
    ...
    deftest_mixing_price_included_excluded_with_affect_base(self):
    ...
    deftest_price_included_repartition_sum_0(self):
        """Teststhecasewhereataxwithanon-zerovaluehasasum
        oftaxrepartitionfactorsofzeroandisincludedinprice.It
        shouldn'tbehaveinthesamewayasa0%tax.
        """
        test_tax=self.env['account.tax'].create({
            'name':"Definitelynota0%tax",
            'amount_type':'percent',
            'amount':42,
            'price_include':True,
            'invoice_repartition_line_ids':[
