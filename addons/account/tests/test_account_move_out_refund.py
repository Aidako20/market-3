...
classTestAccountMoveOutRefundOnchanges(AccountTestInvoicingCommon):
    ...
    deftest_out_refund_line_onchange_product_1(self):
    ...
    deftest_out_refund_line_onchange_business_fields_1(self):
        move_form=Form(self.invoice)
        withmove_form.invoice_line_ids.edit(0)asline_form:
    ...
    deftest_out_refund_line_onchange_accounting_fields_1(self):
        move_form=Form(self.invoice)
        withmove_form.line_ids.edit(2)asline_form:
    ...
    deftest_out_refund_line_onchange_partner_1(self):
        move_form=Form(self.invoice)
    ...
    deftest_out_refund_line_onchange_taxes_1(self):
        move_form=Form(self.invoice)
        withmove_form.invoice_line_ids.edit(0)asline_form:
    ...
    deftest_out_refund_line_onchange_cash_rounding_1(self):
        ...
        repartition_line=self.tax_sale_a.refund_repartition_line_ids.filtered(lambdax:x.repartition_type=='tax')
        ...
        self.assertInvoiceValues(biggest_tax_invoice,[
            ...
            {
                **self.tax_line_vals_2,
                'tax_repartition_line_id':self.tax_sale_b.refund_repartition_line_ids.filtered(lambdax:x.repartition_type=='tax').id,
                'tax_tag_ids':[],
            },
            {
    ...
    deftest_out_refund_line_onchange_currency_1(self):
        move_form=Form(self.invoice)
    ...
    deftest_out_refund_create_1(self):
    ...
    deftest_out_refund_write_1(self):
        #Testcreatinganaccount_movewiththeleastinformation.
        move=self.env['account.move'].create({
            'move_type':'out_refund',
            'partner_id':self.partner_a.id,
    ...
    deftest_out_refund_reverse_caba(self):
