...
classTestInvoiceTaxAmountByGroup(AccountTestInvoicingCommon):
    ...
    defassertAmountByTaxGroup(self,invoice,expected_values):
        current_values=[(x[6],x[2],x[1])forxininvoice.amount_by_group]
        self.assertEqual(current_values,expected_values)

    deftest_multiple_tax_lines(self):
        ...
        #Samebutbotharesharingthesametaxgroup.
    ...
    deftest_tax_affect_base_1(self):
        tax_10=self.env['account.tax'].create({
            'name':"tax_10",
            'amount_type':'percent',
            'amount':10.0,
    ...
    deftest_tax_affect_base_2(self):
        tax_10=self.env['account.tax'].create({
            'name':"tax_10",
            'amount_type':'percent',
            'amount':10.0,
