...
classTestAccountMoveOutInvoiceOnchanges(AccountTestInvoicingCommon):
    ...
    deftest_out_invoice_onchange_invoice_date(self):
    ...
    deftest_out_invoice_line_onchange_product_1(self):
    ...
    deftest_out_invoice_line_onchange_product_2_with_fiscal_pos_1(self):
    ...
    deftest_out_invoice_line_onchange_product_2_with_fiscal_pos_2(self):
    ...
    deftest_out_invoice_line_onchange_business_fields_1(self):
        move_form=Form(self.invoice)
        withmove_form.invoice_line_ids.edit(0)asline_form:
            #Currentprice_unitis1000.
            #Wesetquantity=4,discount=50%,price_unit=400.Thedebit/creditfieldsdon'tchangebecause(4*500)*0.5=1000.
    ...
    deftest_out_invoice_line_onchange_accounting_fields_1(self):
        move_form=Form(self.invoice)
        withmove_form.line_ids.edit(2)asline_form:
            #Customcreditonthefirstproductline.
            line_form.credit=3000
        withmove_form.line_ids.edit(3)asline_form:
            #Customdebitonthesecondproductline.Creditshouldberesetbyonchange.
            #/!\It'sanegativeline.
            line_form.debit=500
        withmove_form.line_ids.edit(0)asline_form:
            #Customcreditonthefirsttaxline.
            line_form.credit=800
        withmove_form.line_ids.edit(4)asline_form:
            #Customcreditonthesecondtaxline.
    ...
    deftest_out_invoice_line_onchange_partner_1(self):
        move_form=Form(self.invoice)
    ...
    deftest_out_invoice_line_onchange_taxes_1(self):
        move_form=Form(self.invoice)
        withmove_form.invoice_line_ids.edit(0)asline_form:
    ...
    deftest_out_invoice_line_onchange_rounding_price_subtotal_1(self):
        '''Seekforroundingissueontheprice_subtotalwhendealingwithaprice_unithavingmoredigitsthanthe
        foreigncurrencyone.
        '''
        ...
        self.assertTrue(decimal_precision,"Decimalprecision'%s'notfound"%decimal_precision_name)

        self.currency_data['currency'].rounding=0.01
        decimal_precision.digits=4

        defcheck_invoice_values(invoice):
            self.assertInvoiceValues(invoice,[
                {
                    'quantity':1.0,
                    'price_unit':0.025,
    ...
    deftest_out_invoice_line_onchange_rounding_price_subtotal_2(self):
        """Ensurethecycliccomputationsimplementedusingonchangesarenotleadingtoroundingissueswhenusing
        price-includedtaxes.
        Forexample:
        100/1.21~=82.64but82.64*1.21~=99.99!=100.0.
        """
    ...
    deftest_out_invoice_line_onchange_taxes_2_price_unit_tax_included(self):
        '''Seekforroundingissueinthepriceunit.Supposeaprice_unitof2300witha5.5%price-includedtax
        appliedonit.

        Thecomputedbalancewillbecomputedasfollow:2300.0/1.055=2180.0948~2180.09.
        Sinceaccounting/businessfieldsaresynchronized,theinversecomputationwilltrytorecomputethe
        price_unitbasedonthebalance:2180.09*1.055=2299.99495~2299.99.

        Thistestensurestheprice_unitisnotoverriddeninsuchcase.
        '''
        tax_price_include=self.env['account.tax'].create({
            'name':'Tax5.5%priceincluded',
            'amount':5.5,
            'amount_type':'percent',
            'price_include':True,
        })
        ...
        #price_unit=2300with15%tax(excluded)+5.5%tax(included).
        move_form=Form(self.invoice)
    ...
    deftest_out_invoice_line_onchange_analytic(self):
        ...
        #Thetaxisnotflaggedasananalyticone.Itshouldchangenothingonthetaxes.
        self.assertInvoiceValues(self.invoice,[
            {
                **self.product_line_vals_1,
        ...
        #Thetaxisflaggedasananalyticone.
        #Anewtaxlinemustbegenerated.
        self.assertInvoiceValues(self.invoice,[
            {
                **self.product_line_vals_1,
                'analytic_account_id':analytic_account.id,
    ...
    deftest_out_invoice_line_onchange_analytic_2(self):
        self.env.user.groups_id+=self.env.ref('analytic.group_analytic_accounting')
        ...
        #Wecanremovetheanalyticaccount,itisnotrecomputedbyaninvalidation
        self.invoice.write({'invoice_line_ids':[(1,self.invoice.invoice_line_ids.ids[0],{
            'analytic_account_id':False,
        })]})
    ...
    deftest_out_invoice_line_onchange_cash_rounding_1(self):
        ...
        repartition_line=self.tax_sale_a.invoice_repartition_line_ids.filtered(lambdax:x.repartition_type=='tax')
        ...
        self.assertInvoiceValues(biggest_tax_invoice,[
            ...
            {
                **self.tax_line_vals_2,
                'tax_repartition_line_id':self.tax_sale_b.invoice_repartition_line_ids.filtered(lambdax:x.repartition_type=='tax').id,
                'tax_tag_ids':[],
            },
            {
    ...
    deftest_cash_rounding_with_rounding_method_set_to_global(self):
        """
        Testthatcashroundingsarecomputedcorrectlywhen
        taxcalculationroundingmethodissetto`round_globally`.
        """
    ...
    deftest_out_invoice_line_onchange_currency_1(self):
    ...
    deftest_out_invoice_line_tax_fixed_price_include_free_product(self):
    ...
    deftest_out_invoice_line_taxes_fixed_price_include_free_product(self):
        '''Checkthatfixedtaxincludearecorrectlycomputedwhiletheprice_unitis0
        '''
        #pleaseensurethistestremainsconsistentwith
        #test_free_product_and_price_include_fixed_taxinthesalemodule
    ...
    deftest_out_invoice_create_refund(self):
    ...
    deftest_out_invoice_create_refund_multi_currency(self):
    ...
    deftest_out_invoice_create_refund_auto_post(self):
        self.invoice.action_post()
    ...
    deftest_out_invoice_create_1(self):
    ...
    deftest_out_invoice_create_child_partner(self):
        #Testcreatinganaccount_moveonachildpartner.
        #Thisneedstoattachthelinestotheparentpartnerid.
        ...
        self.assertEqual(partner_a_child.id,move.partner_id.id,'Keepchildpartnerontheaccountmoverecord')
        self.assertEqual(self.partner_a.id,move.line_ids[0].partner_id.id,'Setparentpartnerontheaccountmovelinerecords')

    deftest_out_invoice_write_1(self):
        #Testcreatinganaccount_movewiththeleastinformation.
        move=self.env['account.move'].create({
            'move_type':'out_invoice',
            'partner_id':self.partner_a.id,
    ...
    deftest_out_invoice_write_2(self):
        '''Ensuretonotmessingtheinvoicewhenwritingabadaccounttype.'''
        move=self.env['account.move'].create({
            'move_type':'out_invoice',
            'partner_id':self.partner_a.id,
            'invoice_line_ids':[
        ...
        receivable_lines=move.line_ids.filtered(lambdaline:line.account_id.user_type_id.type=='receivable')
        not_receivable_lines=move.line_ids-receivable_lines

        #Writeareceivableaccountonanot-receivableline.
        ...
        #Writeanot-receivableaccountonareceivableline.
        withself.assertRaises(UserError),self.cr.savepoint():
            receivable_lines.write({'account_id':not_receivable_lines[0].account_id.copy().id})

        #Writeanotherreceivableaccountonareceivableline.
        receivable_lines.write({'account_id':receivable_lines[0].account_id.copy().id})

    deftest_out_invoice_post_1(self):
        '''Checktheinvoice_datewillbesetautomaticallyatthepostdate.'''
        frozen_today=fields.Date.today()
        withpatch.object(fields.Date,'today',lambda*args,**kwargs:frozen_today),patch.object(fields.Date,'context_today',lambda*args,**kwargs:frozen_today):
            #Createaninvoicewithrate1/3.
            move=self.env['account.move'].create({
                'move_type':'out_invoice',
                'partner_id':self.partner_a.id,
            ...
            #Removetheinvoice_datetocheck:
            #-Theinvoice_datemustbesetautomaticallyattodayduringthepost.
            #-Astheinvoice_datechanged,datedidtoosothecurrencyratehaschanged(1/3=>1/2).
            #-Adifferentinvoice_dateimpliesalsoanewdate_maturity.
            #Addamanualeditionofataxline:
            #-Themodificationmustbepreservedinthebusinessfields.
            #-Thejournalentrymustbebalancedbefore/afterthepost.
            move.write({
                'invoice_date':False,
                'line_ids':[
                    (1,move.line_ids.filtered(lambdaline:line.tax_line_id.id==self.tax_line_vals_1['tax_line_id']).id,{
                        'amount_currency':-200.0,
                    }),
                    (1,move.line_ids.filtered(lambdaline:line.date_maturity).id,{
    ...
    deftest_out_invoice_post_2(self):
        '''Checkthedatewillbesetautomaticallyatthenextavailablepostdateduetothetaxlockdate.'''
        #Createaninvoicewithrate1/3.
        move=self.env['account.move'].create({
            'move_type':'out_invoice',
            'partner_id':self.partner_a.id,
        ...
        #Setthetaxlockdate:
        #-Thedatemustbesetautomaticallyatthedateafterthetax_lock_date.
        #-Asthedatechanged,thecurrencyratehaschanged(1/3=>1/2).
    ...
    deftest_out_invoice_switch_out_refund_1(self):
        #Testcreatinganaccount_movewithanout_invoice_typeandswitchitinanout_refund.
        move=self.env['account.move'].create({
            'move_type':'out_invoice',
            'partner_id':self.partner_a.id,
            'invoice_date':fields.Date.from_string('2019-01-01'),
    ...
    deftest_out_invoice_switch_out_refund_2(self):
        #Testcreatinganaccount_movewithanout_invoice_typeandswitchitinanout_refundandanegativequantity.
    ...
    deftest_out_invoice_reverse_move_tags(self):
        ...
        taxes=self.env['account.tax'].create([{
            'name':"Testtaxinclude_base_amount=%s"%include_base_amount,
            'amount':10.0,
        ...
        }fori,include_base_amountinenumerate((True,False))])
    ...
    deftest_out_invoice_change_period_accrual_1(self):
        move=self.env['account.move'].create({
            'move_type':'out_invoice',
            'date':'2017-01-01',
            'partner_id':self.partner_a.id,
    ...
    deftest_out_invoice_multi_date_change_period_accrual(self):
        ...
        fordate,move,refinzip(dates,moves,['INV/2017/01/0001','INV/2017/01/0002','INV/2017/02/0001']):
            self.assertInvoiceValues(move,[
                {
                    **self.product_line_vals_1,
                    'currency_id':self.currency_data['currency'].id,
    ...
    deftest_out_invoice_filter_zero_balance_lines(self):
    ...
    deftest_out_invoice_recomputation_receivable_lines(self):
        '''Testatrickyspecificcasecausedbysomeframeworklimitations.Indeed,when
        savingarecord,somefieldsarewrittentotherecordsevenifthevalueisthesame
        asthepreviousone.Itcouldleadtoanunbalancedjournalentrywhentherecomputed
        lineisthereceivable/payableone.

        Forexample,thecomputedprice_subtotalarethefollowing:
        ...
        Butwhenrecomputingthereceivableline:
        909688.96/0.14=6497778.285714286=>6497778.29

        Thisrecomputationwasmadebecausetheframeworkwaswritingthesame'price_unit'
        asthepreviousvalueleadingtoarecomputationofthedebit/credit.
        '''
    ...
    deftest_out_invoice_rounding_recomputation_receivable_lines(self):
        '''Testroundingerrorduetothefactthatsubtractingthenroundingisdifferentfrom
        roundingthensubtracting.
        '''
        self.env['decimal.precision'].search([
            ('name','=',self.env['account.move.line']._fields['price_unit']._digits),
        ]).digits=5
    ...
    deftest_out_invoice_multi_company(self):
        '''Ensurethepropertiesarefoundontherightcompany.
        '''
        ...
        def_check_invoice_values(invoice):
            self.assertInvoiceValues(invoice,[
                {
                    'product_id':product.id,
    ...
    deftest_out_invoice_multiple_switch_payment_terms(self):
        '''Whenswitchingimmediatepaymenttermto30%advancethenbacktoimmediatepaymentterm,ensurethe
        receivablelineisbacktoitspreviousvalue.Ifsomebusinessfieldsarenotwellupdated,itcouldleadtoa
        recomputationofdebit/creditwhenwritingandthen,anunbalancedjournalentry.
        '''
        #assertNotUnbalancedEntryWhenSaving
        withForm(self.invoice)asmove_form:
            move_form.invoice_payment_term_id=self.pay_terms_b   #Switchto30%inadvancepaymentterms
            move_form.invoice_payment_term_id=self.pay_terms_a   #Backtoimmediatepaymentterm

    deftest_out_invoice_copy_custom_date(self):
        """Whencreatingarefundforagiveninvoice,theinvoiceiscopiedfirst.Thistestensuresthepayment
        termsarewellrecomputedinordertotakethenewdateintoaccount.
        """
        invoice=self.env['account.move'].create({
            'move_type':'out_invoice',
            'invoice_date':'2017-01-01',
    ...
    deftest_select_specific_product_account(self):
        """Whenaproducthasaspecificincomeaccount,thelattershouldbeusedontherelatedaccountmove
        lines.
        """
    ...
    deftest_out_invoice_note_and_tax_partner_is_set(self):
        #Makesurethat,whencreatinganinvoicebygivingalistoflineswiththelastonebeinganote,
        #thepartner_idofthetaxlineisproperlyset.
        invoice_vals_list=[{
            'move_type':'out_invoice',
            'currency_id':self.currency_data['currency'].id,
            'partner_id':self.partner_a.id,
    ...
    deftest_out_invoice_reverse_caba(self):
    ...
    deftest_out_invoice_duplicate_currency_rate(self):
        '''Testthecorrectupdateofcurrencyrateoninvoiceduplication'''
        move_form=Form(self.invoice)
        move_form.date='2016-01-01'
        move_form.currency_id=self.currency_data['currency']
        move_form.save()
        ...
        #===Duplicateinvoice.Thecurrencyconversion'srateshouldchangetomatchtodayrate===

        copy=self.invoice.copy()
        copy.action_post()

        self.assertRecordValues(
            copy.line_ids.filtered(lambdal:notl.exclude_from_invoice_tab),
            [
                {
                    'currency_id':self.currency_data['currency'].id,
                    'amount_currency':-1000.0,
    ...
    deftest_out_invoice_depreciated_account(self):
        move=self.env['account.move'].create({
            'move_type':'out_invoice',
            'currency_id':self.currency_data['currency'].id,
            'partner_id':self.partner_a.id,
    ...
    @freeze_time('2019-01-01')
    deftest_date_reversal_exchange_move(self):
        """
        Testthedateofthereversalofanexchangemovecreatedwhenunreconcilingapaymentmadeinthepast,whennolockdateisset.
        Itshouldbethelastdayofthemonthoftheexchangemovedateifsequenceisincrementedbymonth,
        andthelastdayoftheyearoftheexchangemovedateifsequenceisincrementedbyyear.
        """
        forformat_incrementor,expected_datein(('month','2017-01-31'),('year','2017-12-31')):
            withself.subTest(format_incrementor=format_incrementor,expected_date=expected_date):
                ...
                new_exchange_journal=self.env['account.journal'].create({
                    'name':f'ExchangeJournalfor{invoice.name}',
                    'code':f'EXCH{invoice.name}',
                    'type':'general',
                    'company_id':self.env.company.id,
                })

                #Needafirstmoveinthenewjournaltoinitiatethesequencewitharightincrementor,dependingonthewantedformat
                self.env['account.move'].create({
                    'journal_id':new_exchange_journal.id,
                    'name':'EXCH/2019/00001'ifformat_incrementor=='year'else'EXCH/2019/01/0001',
                    'line_ids':[
                        (0,0,{
                ...
                line_receivable=invoice.line_ids.filtered(lambdal:l.account_id.internal_type=='receivable')

                exchange_move=line_receivable.full_reconcile_id.exchange_move_id

                #Dateoftheexchangemoveshouldbethedateofthepayment
                ...
                #Dateofthereversaloftheexchangemoveshouldbethelastdayofthemonth/yearofthepaymentdependingonthesequenceformat
                self.assertEqual(exchange_move_reversal.date,fields.Date.to_date(expected_date))

    @freeze_time('2023-05-01')
    deftest_caba_with_different_lock_dates(self):
        """
        TestthedateoftheCABAmovewhenreconcilingapaymentwithaninvoice
        withdatebeforefiscalyear_periodbutafterperiod_lock_datewhen
        havingaccountantrights.
        """
        self.env.company.tax_exigibility=True
        ...
        ifnotself.env.user.user_has_groups('account.group_account_manager'):
        ...
        (invoice+payment.move_id).line_ids\
            .filtered(lambdax:x.account_internal_typein('receivable','payable'))\
            .reconcile()
    ...
    deftest_post_valid_invoices_when_auto_post(self):
        ...
        self.assertEqual(invalid_invoice_1.message_ids[0].body,
                         "<p>Themovecouldnotbepostedforthefollowingreason:"
                         "Thefield'Customer'isrequired,pleasecompleteittovalidatetheCustomerInvoice.</p>")
        self.assertEqual(invalid_invoice_2.state,'draft')
        self.assertEqual(invalid_invoice_2.message_ids[0].body,
                         "<p>Themovecouldnotbepostedforthefollowingreason:Youneedtoaddalinebeforeposting.</p>")
