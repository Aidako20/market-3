...
fromflectra.tools.miscimportformat_amount

@tagged('post_install','-at_install')
classTestAccountJournalDashboard(AccountTestInvoicingCommon):

    @freeze_time("2019-01-22")
    deftest_customer_invoice_dashboard(self):
        ...
        #Checkpartial
        receivable_account=refund.line_ids.mapped('account_id').filtered(lambdaa:a.internal_type=='receivable')
        ...
        (refund+payment.move_id).line_ids\
            .filtered(lambdaline:line.account_internal_type=='receivable')\
            .reconcile()
    ...
    deftest_last_statement(self):
        ...
        forinvoice,paymentinzip(invoices,payments):
    ...
    deftest_sale_purchase_journal_for_multi_currency_purchase(self):
    ...
    deftest_sale_purchase_journal_for_multi_currency_sale(self):
        currency=self.currency_data['currency']
        company_currency=self.company_data['currency']
