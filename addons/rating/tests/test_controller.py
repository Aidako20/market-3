...
fromflectra.testsimportHttpCase,tagged,new_test_user

@tagged('post_install','-at_install')
classTestControllersRoute(HttpCase):
    ...
    deftest_controller_rating(self):
        ...
        self.assertEqual(req.status_code,200,"Responseshould=OK")
