...
classTestUBLDE(TestUBLCommon):
    ...
    defsetup_company_data(cls,company_name,chart_template):
        #OVERRIDE
        #toforcethecompanytobegerman+addphoneandemail
    ...
    deftest_import_export_invoice_xml(self):
        """
        Testwhethertheelementswhichareonlyspecifictoubl_dearecorrectlyexported
        ...
        #Export:BuyerReferenceisintheout_invoicexml
