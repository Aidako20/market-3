...
classEmployee(models.Model):
    ...
    defaction_open_employee_cars(self):
        ...
        return{
            ...
            "name":"HistoryEmployeeCars",
        }

    def_compute_employee_cars_count(self):
        ...
        mapped_data={
            ...
            forgroupinfleet_data
        }
        foremployeeinself:
            drivers=employee.user_id.partner_id|employee.sudo().address_home_id
            employee.employee_cars_count=sum(mapped_data.get(pid,0)forpidindrivers.ids)
