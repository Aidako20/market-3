#-*-coding:utf-8-*-
fromflectra.addons.account.tests.test_taximportTestTaxCommon
fromflectra.testsimporttagged


@tagged('post_install','-at_install')
classTestTaxPython(TestTaxCommon):
    ...
    deftest_tax_python_price_include(self):
