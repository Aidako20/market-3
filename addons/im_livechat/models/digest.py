...
classDigest(models.Model):
    ...
    def_compute_kpi_livechat_rating_value(self):
        ...
        forrecordinself:
            ...
            record.kpi_livechat_rating_value=ratings['great']*100/sum(ratings.values())ifsum(ratings.values())else0

    def_compute_kpi_livechat_conversations_value(self):
        forrecordinself:
            start,end,company=record._get_kpi_compute_parameters()
    ...
    def_compute_kpi_livechat_response_value(self):
        forrecordinself:
            start,end,company=record._get_kpi_compute_parameters()
            ...
            record.kpi_livechat_response_value="%.2f"%sum([response['time_to_answer']forresponseinresponse_time])or0
