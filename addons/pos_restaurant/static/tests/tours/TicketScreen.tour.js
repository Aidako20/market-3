flectra.define('pos_restaurant.tour.TicketScreen',function(require){
    ...
    //NewTicketbuttonshouldnotbeintheticketscreenifnotableisselected.
    Chrome.do.clickTicketButton();
    TicketScreen.check.noNewTicketButton();
    TicketScreen.do.clickDiscard();

    //Deletingthelastorderinthetablebringsbacktofloorscreen
    ...
    //Create2itemsinatable.Fromfloorscreen,delete1item.Thenselecttheotheritem.
    //CorrectorderandscreenshouldbedisplayedandtheBackToFloorButtonisshown.
    ...
    //Makesurethatorderisdeletedproperly.
    FloorScreen.do.clickTable('T5');
    ProductScreen.exec.addOrderline('MinuteMaid','1','3');
