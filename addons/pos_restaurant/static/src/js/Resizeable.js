flectra.define('pos_restaurant.Resizeable',function(require){
    ...
    classResizeableextendsPosComponent{
        constructor(){
            super(...arguments);
        ...
        resizeN(event){
            if(this.isResizingN){
                ...
                letdY=newY-this.startY;
                if(dY<0&&Math.abs(dY)>this.loc.top){
                    dY=-this.loc.top;
                }elseif(dY>0&&dY>this.size.height){
                    dY=this.size.height;
                }
        ...
        resizeS(event){
            if(this.isResizingS){
                ...
                }elseif(dY<0&&Math.abs(dY)>this.size.height){
                    dY=-this.size.height;
                }
                this.el.style.height=`${this.size.height+dY}px`;
            }
        ...
        resizeW(event){
            if(this.isResizingW){
                ...
                letdX=newX-this.startX;
                if(dX>0&&dX>this.size.width){
                    dX=this.size.width;
                }elseif(dX<0&&Math.abs(dX)>this.loc.left+Math.abs(this.limitLeft)){
            ...
            if(this.isResizingE){
                ...
                if(
                    ...
                    dX=
                        this.limitAreaWidth-
                        (this.size.width+this.loc.left+Math.abs(this.limitLeft));
                }elseif(dX<0&&Math.abs(dX)>this.size.width){
                    dX=-this.size.width;
                }
                this.el.style.width=`${this.size.width+dX}px`;
            }
