...
constFieldOne2Many=require('web.relational_fields').FieldOne2Many;

constSoLineOne2Many=FieldOne2Many.extend({
    _onFieldChanged:function(ev){
        if(
            ...
            constline=this.value.data.find(line=>{
                returnline.id===ev.data.changes.timesheet_ids.id;
            });
