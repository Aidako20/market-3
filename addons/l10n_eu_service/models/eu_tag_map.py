...
"""
TheEU_TAG_MAPanswersthequestion:"whichtagshouldIapplyontheOSStaxrepartitionline?"

{
    'fiscal_country_code':{
        'invoice_base_tag':xml_id_of_the_tagorNone,
        'invoice_tax_tag':xml_id_of_the_tagorNone,
        'refund_base_tag':xml_id_of_the_tagorNone,
        'refund_tax_tag':xml_id_of_the_tagorNone,
    },
}
"""
...
EU_TAG_MAP={
    ...
    #Czech-Donein13.0-CoAnotavailableyet
    ...
    #Estonia-Donein13.0-CoAnotavailableyet
    'EE':{
        'invoice_base_tag':None,
        'invoice_tax_tag':None,
        'refund_base_tag':None,
    ...
    #Malta-Donein13.0-CoAnotavailableyet
    'MT':{
        'invoice_base_tag':None,
        'invoice_tax_tag':None,
        'refund_base_tag':None,
    ...
    #Slovakia-Donein13.0-CoAnotavailableyet
