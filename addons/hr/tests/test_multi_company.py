...
classTestMultiCompany(TestHrCommon):
    ...
    deftest_multi_company_report(self):
    ...
    deftest_single_company_report(self):
        withself.assertRaises(QWebException): #CacheMissfollowedbyAccessError
