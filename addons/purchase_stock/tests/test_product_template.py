...
classTestProductTemplate(TransactionCase):
    deftest_name_search(self):
      ...
      self.assertEqual(len(ns),1,"name_searchshouldhave1item")
      self.assertEqual(ns[0][1],'[VOB2A]RubberDuck',"name_searchshouldreturntheexpectedresult")
