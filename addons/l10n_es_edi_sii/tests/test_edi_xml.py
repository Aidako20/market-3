...
classTestEdiXmls(TestEsEdiCommon):

    @classmethod
    defsetUpClass(cls):
        super().setUpClass()
        cls.certificate.write({
            'date_start':'2019-01-0101:00:00',
            'date_end':'2021-01-0101:00:00',
        })

    deftest_010_out_invoice_s_iva10b_s_iva21s(self):
        withfreeze_time(self.frozen_today):
    ...
    deftest_020_out_invoice_s_iva10b_s_iva0_ns(self):
        withfreeze_time(self.frozen_today):
            invoice=self.create_invoice(
    ...
    deftest_030_out_invoice_s_iva10b_s_req014_s_iva21s_s_req52(self):
        withfreeze_time(self.frozen_today):
            invoice=self.create_invoice(
                partner_id=self.partner_a.id,
                invoice_line_ids=[
    ...
    deftest_040_out_refund_s_iva10b_s_iva10b_s_iva21s(self):
        withfreeze_time(self.frozen_today):
            invoice=self.create_invoice(
    ...
    deftest_050_out_invoice_s_iva0_sp_i_s_iva0_ic(self):
        withfreeze_time(self.frozen_today):
            invoice=self.create_invoice(
                partner_id=self.partner_a.id,
                invoice_line_ids=[
    ...
    deftest_060_out_refund_s_iva0_sp_i_s_iva0_ic(self):
        withfreeze_time(self.frozen_today):
            invoice=self.create_invoice(
                move_type='out_refund',
                partner_id=self.partner_a.id,
    ...
    deftest_070_out_invoice_s_iva_e_s_iva0_e(self):
        withfreeze_time(self.frozen_today):
            invoice=self.create_invoice(
                partner_id=self.partner_a.id,
                invoice_line_ids=[
    ...
    deftest_080_out_refund_s_iva0_sp_i_s_iva0_ic(self):
        withfreeze_time(self.frozen_today):
            invoice=self.create_invoice(
                move_type='out_refund',
                partner_id=self.partner_a.id,
    ...
    deftest_085_out_refund_s_iva0_sp_i_s_iva0_ic_multi_currency(self):
        withfreeze_time(self.frozen_today):
            invoice=self.create_invoice(
                move_type='out_refund',
                partner_id=self.partner_a.id,
    ...
    deftest_090_in_invoice_p_iva10_bc_p_irpf19_p_iva21_sc_p_irpf19(self):
        withfreeze_time(self.frozen_today):
            invoice=self.create_invoice(
    ...
    deftest_100_in_refund_p_iva10_bc(self):
        withfreeze_time(self.frozen_today):
            invoice=self.create_invoice(
                move_type='in_refund',
                ref='sup0001',
    ...
    deftest_110_in_invoice_p_iva10_bc_p_req014_p_iva21_sc_p_req52(self):
        withfreeze_time(self.frozen_today):
            invoice=self.create_invoice(
                move_type='in_invoice',
                ref='sup0001',
    ...
    deftest_120_in_invoice_p_iva21_sp_ex(self):
        withfreeze_time(self.frozen_today):
            invoice=self.create_invoice(
                move_type='in_invoice',
                ref='sup0001',
    ...
    deftest_130_in_invoice_p_iva0_ns_p_iva10_bc(self):
        #TODOmakeitwork
        withfreeze_time(self.frozen_today):
            invoice=self.create_invoice(
                move_type='in_invoice',
    ...
    deftest_140_out_invoice_s_iva10b_s_irpf1(self):
        #TODO:debug
        withfreeze_time(self.frozen_today):
            invoice=self.create_invoice(
                partner_id=self.partner_b.id,
    ...
    deftest_150_in_invoice_p_iva10_bc_p_irpf1(self):
        withfreeze_time(self.frozen_today):
            invoice=self.create_invoice(
                move_type='in_invoice',
                ref='sup0001',
    ...
    deftest_160_in_refund_p_iva10_bc_p_irpf1(self):
        withfreeze_time(self.frozen_today):
            invoice=self.create_invoice(
                move_type='in_refund',
                ref='sup0001',
    ...
    deftest_165_in_refund_p_iva10_bc_p_irpf1_multi_currency(self):
        withfreeze_time(self.frozen_today):
            invoice=self.create_invoice(
                move_type='in_refund',
                ref='sup0001',
