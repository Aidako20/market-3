...
fromflectra.addons.base.tests.commonimportSavepointCase


classTestSaleCommonBase(SavepointCase):
    '''Setupwithsaletestconfiguration.'''

    @classmethod
    defsetup_sale_configuration_for_company(cls,company):
        ...
        company_data.update({
            ...
            'product_service_order':cls.env['product.product'].with_company(company).create({
                ...
                'description':'Exampleofproducttoinvoiceonorder',
...
classTestSaleCommon(AccountTestInvoicingCommon,TestSaleCommonBase):
    '''Setuptobeusedpost-installwithsaleandaccountingtestconfiguration.'''
