...
classTestSalesCommon(SavepointCase):

    @classmethod
    defsetUpClass(cls):
        super(TestSalesCommon,cls).setUpClass()

        #Salesmenorganization
        #------------------------------------------------------------
        ...
        cls.user_sales_leads=mail_new_test_user(
            ...
            name='LaetitiaSalesLeads',email='crm_leads@test.example.com',
            company_id=cls.company_main.id,
            notification_type='inbox',
        ...
        cls.user_sales_salesman=mail_new_test_user(
            ...
            name='OrteilSalesOwn',email='crm_salesman@test.example.com',
            company_id=cls.company_main.id,
            notification_type='inbox',
...
classTestSalesMC(TestSalesCommon):
    """MultiCompany/MultiSalesTeamenvironment"""
