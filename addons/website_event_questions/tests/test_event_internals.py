...
fromflectra.addons.website_event_questions.controllers.mainimportWebsiteEvent
fromflectra.addons.website_event_questions.tests.commonimportTestEventQuestionCommon


classTestEventData(TestEventQuestionCommon):

    @users('user_eventmanager')
    deftest_event_type_configuration_from_type(self):
    ...
    deftest_process_attendees_form(self):
        event=self.env['event.event'].create({
            'name':'EventUpdateType',
        ...
        form_details={
            ...
            'question_answer-0-%s'%self.event_question_3.id:'FreeText',
        }
        ...
        self.assertEqual(registrations,[
            ...
            'registration_answer_ids':[
                ...
                (0,0,{'question_id':self.event_question_3.id,'value_text_box':'FreeText'})]},
