...
varSlideUnsubscribeDialog=Dialog.extend({
    ...
    getSubscriptionState:function(){
        returnthis.$('input#subscribed').prop('checked');
    },
    ...
    _getModalButtons:function(){
        ...
        if(state==='_subscription'){
            ...
            btnList.push({text:_t("orLeavethecourse"),classes:"btn-dangerml-auto",click:this._onClickLeaveCourse.bind(this)});
        }elseif(state==='_leave'){
            btnList.push({text:_t("Leavethecourse"),classes:"btn-danger",click:this._onClickLeaveCourseSubmit.bind(this)});
...
publicWidget.registry.websiteSlidesUnsubscribe=publicWidget.Widget.extend({
    ...
    _openDialog:function($element){
        ...
        returnnewSlideUnsubscribeDialog(this,data).open();
    },
