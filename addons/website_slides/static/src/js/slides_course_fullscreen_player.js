...
flectra.define('website_slides.fullscreen', function (require) {
    ...
    var VideoPlayer = publicWidget.Widget.extend({
        ...
        _setupPeerTubePlayer: function () {
            ...
            /*this.player = new PeerTubePlayer(document.querySelector('#video-player' + this.slide.id));
            this.player.ready; // wait for the player to be ready
            this.player.addEventListener('playbackStatusUpdate', this._onPlaybackStatusUpdate.bind(this));
            this.player.play();*/
        },
        /**
