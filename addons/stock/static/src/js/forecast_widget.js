...
constForecastWidgetField=AbstractField.extend({
    supportedFieldTypes:['float'],

    _render:function(){
        vardata=Object.assign({},this.record.data,{
    ...
    /**
     *OpenstheForecastReportforthe`stock.move`product.
     *
     *@param{MouseEvent}ev
     */
