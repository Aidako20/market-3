...
class AccountInvoice(models.Model):
    ...
    def onchange_vat_config_type(self):
        if self.vat_config_type:
            ...
            if self.vat_config_type.vat_type == 'designated_zone_purchase':
                fiscal_position_id = self.fiscal_position_id.search([('name', 'ilike', 'exempt')], limit=1)
    ...
    def action_invoice_open(self):
        ...
        for tax_line in self.tax_line_ids:
            ...
            custom_amount += tax_line.amount_total if tax_id.tax_type == 'customs' else 0.0
        ...
        list_data.append((0, 0, self.get_move_line_vals(total_tax_amount - custom_amount)))
        if custom_amount:
    ...
    def _onchange_allowed_purchase_ids(self):
        ...
        result['domain']['purchase_id'] += [('vat_config_type', '=', self.vat_config_type.id), ('reverse_charge', '=', self.reverse_charge)]
        return result
...
class AccountInvoiceLine(models.Model):
    ...
    def get_invoice_line_account(self, type, product, fpos, company):
        return self.invoice_id.vat_config_type.journal_id.default_debit_account_id