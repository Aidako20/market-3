...
varWebsiteEventTrackSuggestion=Widget.extend({
    ...
    /**
     *Iftheuserclicksonreplay,removethissuggestionwindowandsendan
     *eventtotheparentsothatitcanrewindthevideotothebeginning.
     */
    ...
    _updateTimer:function(){
        varsecondsLeft=parseInt(this.$('.owevent_track_suggestion_timer_text').text());
...
returnWebsiteEventTrackSuggestion;
